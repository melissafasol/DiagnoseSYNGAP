...
for animal in analysis_ls:
    ...
    if animal in syngap_2_ls:
        ...
        complexity_calculations = ComplexClass(complexity_calculation=complex_calculation_type, motor_indices=Motor, somatosensory_indices=Somatosensory,
        ...
        for region_type in region_ls:
            ...
            np.save(results_path + str(animal) + '_' + region_type + '_' + complex_calculation_type + '.npy', complex_array)
