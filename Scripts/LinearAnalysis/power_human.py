...
from preprocess_human import load_filtered_data, split_into_epochs, identify_noisy_epochs, remove_duplicate_idx, calculate_psd, plot_psd

human_data_folder = '/home/melissa/PREPROCESSING/SYNGAP1/SYNGAP1_Human_Data/'
save_directory = '/home/melissa/RESULTS/HUMAN/power_plots/'
patient_list = [ 'P1 N1', 'P1 N2', 'P2 N1', 'P2 N2', 'P10 N1', 'P10 N2', 'P11 N1', 'P11 N2', 'P12 N1','P12 N2', 'P13 N1',
                'P13 N2', 'P15 N1', 'P15 N2', 'P16 N1', 'P16 N2', 'P17 N1', 'P17 N2', 'P18 N1', 'P18 N2', 'P19 N1', 'P19 N2', 'P20 N1', 'P20 N2', 'P21 N1', 'P21 N2', 'P22 N1',
               'P22 N2', 'P23 N1', 'P23 N2', 'P24 N1', 'P24 N2', 'P25 N1', 'P25 N2', 'P26 N1', 'P26 N2',
...
for patient in patient_list:
    if patient in manual_list:
        ...
        try:
            ...
            print(rm_dup)
            np.save('/home/melissa/PREPROCESSING/SYNGAP1/human_npy/noise_idx/' + str(patient) + '_noise.npy',  np.array(rm_dup))
            power_concat = calculate_psd(epochs, rm_dup, channels_idx, epochs_idx)
            power_concat.to_csv('/home/melissa/RESULTS/HUMAN/power_df/' + str(patient) + '_power_df.csv')
