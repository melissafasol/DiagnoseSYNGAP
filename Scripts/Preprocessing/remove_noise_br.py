...
from constants import SYNGAP_baseline_start, SYNGAP_baseline_end, channel_variables, seizure_free_IDs, seizure_two_files
...
def preprocess_data_for_animals(animal_ids, directory_path, seizure_free_ids, seizure_br_path, SYNGAP_baseline_start, SYNGAP_baseline_end, channel_variables, br_number):
...
preprocess_data_for_animals(animal_id_list, directory_path, seizure_free_IDs, seizure_br_path, SYNGAP_baseline_start, SYNGAP_baseline_end, channel_variables, br_number)