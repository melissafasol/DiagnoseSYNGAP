...
results_path = '/home/melissa/RESULTS/XGBoost/SYNGAP1/Motor/Hurst'
...
for animal in syngap_2_ls:
    ...
    hurst_12_1 = [compute_hurst_exp(np.expand_dims(epoch, axis = 0)) for epoch in filter_12_1]
    ...
    #hurst_12_2 = [compute_hurst_exp(np.expand_dims(epoch, axis = 0)) for epoch in filter_12_2]
    ...
    np.save(animal + '_hurst_concat.npy', mean_array_1)
    print(animal + ' saved')
